...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DwFvD", function() { return DwFvD; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "templates", function() { return templates; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_metal_component___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_metal_component__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_metal_soy__ = __webpack_require__(0);
...
/**
 * @fileoverview Templates in namespace DwFvD.
 * @public
 */

goog.module('DwFvD.incrementaldom');
...
function $render(opt_data, opt_ignored, opt_ijData) {
  var param957 = function() {
    ie_open('article', null, null,
      ...
      $templateAlias2({code: '<clay-icon spritemap="path/to/icons.svg" symbol="add-column"></clay-icon>\n\n<clay-icon spritemap="path/to/icons.svg" symbol="add-cell"></clay-icon>', mode: 'webcomponents'}, null, opt_ijData);
      ...
      ie_open('ul', null, null,
        ...
        var iconList979 = opt_data.page.icons;
        var iconListLen979 = iconList979.length;
        for (var iconIndex979 = 0; iconIndex979 < iconListLen979; iconIndex979++) {
          var iconData979 = iconList979[iconIndex979];
          ie_open('li');
            ie_open('svg', null, null,
                'class', 'lexicon-icon lexicon-icon-' + iconData979);
              ie_void('use', null, null,
                  'xlink:href', '/vendor/lexicon/icons.svg#' + iconData979);
            ie_close('svg');
            ie_open('span');
              var dyn20 = iconData979;
    ...
    ie_open('article', null, null,
      ...
      ie_open('ul', null, null,
          'class', 'lexicon-icon-list list-unstyled');
        var flagList991 = opt_data.page.flags;
        var flagListLen991 = flagList991.length;
        for (var flagIndex991 = 0; flagIndex991 < flagListLen991; flagIndex991++) {
          var flagData991 = flagList991[flagIndex991];
          ie_open('li');
            ie_open('svg', null, null,
                'class', 'lexicon-icon lexicon-icon-' + flagData991);
              ie_void('use', null, null,
                  'xlink:href', '/vendor/lexicon/icons.svg#' + flagData991);
            ie_close('svg');
            ie_open('span');
              var dyn21 = opt_data.page.flagData[flagData991];
              if (typeof dyn21 == 'function') dyn21(); else if (dyn21 != null) itext(dyn21);
              itext(' (');
              var dyn22 = flagData991;
...
exports.render = $render;
if (goog.DEBUG) {
  $render.soyTemplateName = 'DwFvD.render';
}
...
class DwFvD extends __WEBPACK_IMPORTED_MODULE_0_metal_component___default.a {}
__WEBPACK_IMPORTED_MODULE_1_metal_soy___default.a.register(DwFvD, templates);
...
var DwFvD = function (_Component) {
  _inherits(DwFvD, _Component);

  function DwFvD() {
    _classCallCheck(this, DwFvD);

    return _possibleConstructorReturn(this, (DwFvD.__proto__ || Object.getPrototypeOf(DwFvD)).apply(this, arguments));
  }
...
_metalSoy2.default.register(DwFvD, _iconsLexiconSoy2.default);

exports.default = DwFvD;
